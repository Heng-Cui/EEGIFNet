...
def prepare_data(EEG_all, noise_all, combin_num, train_per, noise_type):
    ...
    elif noise_type == 'motion' or noise_type == 'MIX':  # We will drop some of the EEG signal to much the number of EMG
        EEG_all_random = EEG_all_random[0:noise_all_random.shape[0]]
        print('EEG segments after drop: ',EEG_all_random.shape[0])

    elif noise_type == 'ECG':  # We will drop some of the EEG signal to much the number of EMG
        EEG_all_random = EEG_all_random[0:noise_all_random.shape[0]]
        print('EEG segments after drop: ',EEG_all_random.shape[0])

    elif noise_type == 'PLI':  # We will drop some of the EEG signal to much the number of EMG
        EEG_all_random = EEG_all_random[0:noise_all_random.shape[0]]
        print('EEG segments after drop: ',EEG_all_random.shape[0])
    ...
    SNR_train_dB = np.random.uniform(-5.2, 5.2, (EEG_train.shape[0]))
